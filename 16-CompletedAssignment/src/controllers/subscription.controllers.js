...
const toggleSubscription = asyncHandler(async (req, res) => {
    ...
    if(!subscriber){
        ...
        .status(200)
        .json(
            new ApiResponse(200,newSubscriber,"Subscription is added to the channel")
        );
    }
    ...
    if(!deleteSubscriber){
        ...
        .status(200)
        .json(
            new ApiError(200,deleteSubscriber,"Subscription was removed")
        );
...
const getUserChannelSubscribers = asyncHandler(async (req, res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200,subscriberList[0].subscriberList)
    );
...
const getSubscribedChannels = asyncHandler(async (req, res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200,ChannelList[0].ChannelList,"Subscribed Channel list returned successfully")
    );
